...
input double InpRisk = 1;                     // Risk size
input double InpRiskReward = 1;               // Risk reward
input ENUM_TIMEFRAMES InpTimeFrame = PERIOD_H1; // Range time frame minutes
...
input int InpEndHour = 0;    // End Hour (0 = off)
