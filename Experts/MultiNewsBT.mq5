...
#property description "Multi momentum ATR breakout trading strategy"
...
input long InpMagicNumber = 8;                             // Magic number
input string InpSymbols = "AUDUSD, EURUSD, GBPUSD, USDCAD, USDCHF USDJPY, XAUUSD"; // Symbol
string symbols[];

input group "========= Risk settings =========";
input bool InpRiskFixed = false;                          // fixed risk
double startCapital = AccountInfoDouble(ACCOUNT_BALANCE); // Start capital
input double InpRisk = 1.0;                               // Risk %
input double InpReward = 1.0;                             // Reward %

input group "========= Direction settings =========";
